module.exports = {
  ...
  create(context) {
    ...
    const forbiddenWordsWithSuggestions = new Map([
      ...
      [
        "service",
        "Name by domain action (e.g., OrderSubmitter, PaymentGateway)",
      ],
      [
        "services",
        "Name by domain action (e.g., OrderSubmitter, PaymentGateway)",
      ...
      [
        "manager",
        "Name by responsibility (e.g., ConnectionPool, SessionStore)",
      ],
      [
        "managers",
        "Name by responsibility (e.g., ConnectionPool, SessionStore)",
    ...
    const forbiddenPattern =
      /(^|\/|-)(utils|helpers|helper|service|services|manager|managers|processor|processors|data)(-|[.]ts$|[.]tsx$|\/|$)/i;
