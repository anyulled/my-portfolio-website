...
export const alt = "Models featured by Sensuelle Boudoir";
export const size = { width: 1200, height: 630 };

export default async function ModelsOpenGraphImage() {
  await connection();
  ...
  return new ImageResponse(
    <div tw="flex h-full w-full items-center justify-center bg-neutral-950 text-white">
      <img src={image} alt="Model portrait" tw="h-full w-1/2 object-cover" />
      <div tw="flex h-full w-1/2 flex-col justify-center p-12">
        <h1 tw="text-5xl">Sensuelle Boudoir</h1>
        <h2 tw="text-4xl">Our Models</h2>
      </div>
    </div>,
    size,
  );
