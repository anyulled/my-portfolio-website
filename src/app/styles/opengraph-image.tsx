...
export const alt = "Photography styles by Sensuelle Boudoir";
export const size = { width: 1200, height: 630 };

export default async function StylesOpenGraphImage() {
  await connection();
